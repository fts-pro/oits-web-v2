...
export const metadata: Metadata = {
  title: 'Operate: SRE & Embedded Engineering Pods',
  description: 'Site reliability engineering, continuous roadmap acceleration, and committed incident response SLAs for business-critical software.',
};

export default function OperatePage() {
  const service = SERVICES_OUTCOMES.operate;
