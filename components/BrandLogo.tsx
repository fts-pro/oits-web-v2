...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  const currentMode = theme === 'auto' ? activeTheme : theme;
  ...
  return (
    ...
    >
      {isFull ? (
        ...
        >
          {/* ================= LIGHT MODE LAYER ================= */}
          <g className={currentMode === 'light' ? 'block' : 'hidden'}>
          ...
          {/* ================= DARK MODE LAYER ================= */}
          <g className={currentMode === 'dark' ? 'block' : 'hidden'}>
        ...
        /* Icon variant (seal only) */
        <svg
          viewBox="0 0 200 200"
          className="h-full w-auto overflow-visible"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          aria-label="OITS Dhaka"
          role="img"
        >
          <g transform="translate(10, 10)">
            <circle
              ...
              cy="90"
              r="84"
              stroke={currentMode === 'light' ? '#1D2A68' : '#FFFFFF'}
              strokeWidth="20"
              fill="none"
            />
            <circle
